...
class CallGraph(object):
    ...
    def register_call(self, lam, calling_app, cont_ast=None):
        ...
        if lam not in subdct:
            subdct[lam] = None
            if not calling_lam.body[0].should_enter and self.is_recursive(calling_lam):
