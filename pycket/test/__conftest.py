...
#     parser.addoption('--use-expander', action='store_true', help='Run the tests using the reader and evaluator from expander linklet')

# @pytest.fixture
# def use_expander(request):
#     return request.config.getoption("--use-expander")
