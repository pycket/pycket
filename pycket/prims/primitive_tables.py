...
place = make_primitive_table(["place-break", "place-channel-get", "place-channel-put", "place-sleep", 
...
paramz = make_primitive_table(["check-for-break", "break-enabled-key", "parameterization-key", "cache-configuration", 
...
internal = make_primitive_table(["call/cm", "extract-procedure", "set-ctl-c-handler!", "register-linklet-instantiate-continuation!", 
...
futures = make_primitive_table(["futures-enabled?", "processor-count", "future", "future?", 
...
flfxnum = make_primitive_table(["fx->fl", "fl->fx", "fxabs", "fx+", 
...
extfl = make_primitive_table(["extflmin", "extflatan", "extfl+", "extflmax", 
...
network = make_primitive_table(["tcp-abandon-port", "tcp-accept", "tcp-accept-evt", "tcp-accept-ready?", 
...
foreign = make_primitive_table(["_bool", "_bytes", "_double", "_double*", 
...
linklet = make_primitive_table(["linklet?", "compile-linklet", "recompile-linklet", "eval-linklet", "read-compiled-linklet", "instantiate-linklet",
...
unsafe = make_primitive_table(["unsafe-car", "unsafe-cdr", "unsafe-list-tail", 
